...
public class SVMOptimizer {
	...
	public static void main(String[] args) throws IOException {
		...
		double[] gammas = {0.005, 0.0001};
		double [] costs = {2.2, 2, 1.8};
		...
		br.close();
		FileWriter fw = new FileWriter("output/svmClassification.csv");
		fw.write("record_id\ttopic_id\n");
		...
		for(double gamma: gammas){
			...
			for(double cost: costs){
				...
				trainArgs.append("-s 0 -t 2 -h 0 -g ");
				trainArgs.append(Double.toString(gamma));
				trainArgs.append(" -c ");
				trainArgs.append(Double.toString(cost));
				trainArgs.append(" input/libSVMFormat_NgramClassification.txt model/libsvmClassification6040");
				...
				String [] argv = "input/libSVMFormat_NgramClassificationTest.txt model/libsvmClassification6040 output/libsvm.out".split(" ");
